# This is the full and corrected content for Models/feature_extractors/resnet18.py
...
class ResNetUNet(nn.Module):
    ...
    def forward(self, input):
        ...
        # Decoder Path with robust upsampling
        ...
        x = F.interpolate(x, size=layer0.shape[2:], mode='bilinear', align_corners=False)
