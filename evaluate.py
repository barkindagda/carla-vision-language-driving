    ...
    while episode_idx < episodes:
        ...
        while not done:
            try:
                ...
                # Calculate distance to ego_target (used for success in CarlaEnv)
                ...
                new_row = pd.DataFrame([[
                    ...
                    info_dict.get("distance_to_goal", 0),  # Distance to self.goal
                    distance_to_ego_target,  # Distance to self.ego_target
